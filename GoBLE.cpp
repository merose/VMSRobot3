// Modified from version download from DFRobot site. (2015-11-12 M. Rose)
...
#if 0
  Serial.print("Joystick values raw: ");
  Serial.print(rDataPack.joystickPayload[0]);
  Serial.print(" ");
  Serial.print(rDataPack.joystickPayload[1]);
  Serial.print("   X=");
...
int _GoBLE::bleDataPackageParser() {
  ...
  */
  ...
  for (int i=0; i < 4; ++i) {
    Serial.print(" ");
    Serial.print(rDataPack.joystickPayload[i]);
  }
  Serial.println();
#endif
